...
import { getSourcesData, type SourcesData } from "@/features/sources/queries"
import { formatNumber } from "@/lib/format/money"

function SourcesBody({ data }: { data: SourcesData }) {
  return (
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title="Sources"
      />
      <DataGate load={getSourcesData}>{(data) => <SourcesBody data={data} />}</DataGate>
    </div>
  )
}
